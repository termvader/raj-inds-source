  ...
  Lightbox = (function() {
    ...
    Lightbox.prototype.updateDetails = function() {
      ...
      if (typeof this.album[this.currentImageIndex].description !== 'undefined' && this.album[this.currentImageIndex].description !== "") {
        this.$lightbox.find('.lb-number').text(this.album[this.currentImageIndex].description).fadeIn('fast');
      }
      else if (this.album.length > 1 && this.options.showImageNumberLabel) {
